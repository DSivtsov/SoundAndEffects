...
using GameTestClass;
using PlayModeTest = GameTestClass.PlayMode;
...
public class GameSettingsSimpleSO : ScriptableObject
{
    ...
    [SerializeField] private PlayModeTest _usedPlayMode;
    ...
    public PlayModeTest UsedPlayMode => _usedPlayMode;
    ...
    {
        _levelPlayer = null;
        _usedPlayMode = (PlayModeTest.Offline == _usedPlayMode) ? PlayModeTest.Online : PlayModeTest.Offline;
        _notCopyToGlobal = !_notCopyToGlobal;
